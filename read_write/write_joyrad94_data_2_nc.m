...
netcdf.putAtt(ncid,glob,'contact','Tatiana Nomokonova, tnomokon@uni-koeln.de');
netcdf.putAtt(ncid,glob,'processing script','/home/hatpro/scripts/mirac-a/data_processing/call_process_joyrad94_data.m');
